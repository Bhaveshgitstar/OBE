  ...
  $.get(`/subjectsopt?user=${username}`, function (data) {
    ...
    const coordinatorSubjects = coordinatorIndexes.map((index) => {
      ...
      return (
        subjectCode +
        " (" +
        subjectOpt.find((subject) => subject.co_code === subjectCode).co_name +
        ") "
      );
    });
    ...
    coordinatorSubjects.forEach((subjectName) => {
      subjectDropdown.append(
        $("<option></option>").attr("value", subjectName).text(subjectName)
      );
    });
  });
}
...
$(document).ready(() => {
  ...
  $(".get-data-button").click(function () {
    ...
    window.location.href = `/attainmentt1?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttont2").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `/attainmentt2?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonco").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `/courseoutcome?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttont3").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `attainmentt3?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonta").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `attainmentta?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttoncopso").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `atcopsomap?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonsett1").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `courseexamt1?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonsett2").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `courseexamt2?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonsett3").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `courseexamt3?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonsetta").click(function () {
    const selectedSubject = $("#subjectDropdown").val();
    const indexOfParenthesis = selectedSubject.indexOf(" ");
    const partBeforeParenthesis =
      indexOfParenthesis !== -1
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `courseexamta?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  $(".get-data-buttonopeningreport").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `openingreport?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
  ...
  $(".get-data-buttonclosingreport").click(function () {
    ...
    // Redirect to the attainmentt1 page with the selectedSubject as a query parameter
    window.location.href = `closingreport?subject=${encodeURIComponent(
      partBeforeParenthesis
    )}`;
  });
