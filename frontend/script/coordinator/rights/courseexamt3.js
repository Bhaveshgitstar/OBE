...
function updateco(numQuestions, coValues) {
        ...
        // Send the data to the server via AJAX
        $.ajax({
            url: `/api/submitcot3?code=${window.selectedSubject}`, // Replace with your server's endpoint
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(data),
            success: function(response) {
...
function updatemarks(numQuestions, marksPerQuestion,coValues){
    ...
    // Send the data to the server via AJAX
    $.ajax({
        url: `/api/submitmarkst3?code=${window.selectedSubject}`, // Replace with your server's endpoint
        type: 'POST',
        contentType: 'application/json',
        data: JSON.stringify(data),
        success: function(response) {
