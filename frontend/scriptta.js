...
attainmentValues.forEach((attainment, index) => {
    ...
    $.ajax({
        url: `/api/taattainment/${recordId}`, // Update the URL to match your Express route for T1attainment data
        type: 'PUT',
        dataType: 'json',
...
function deleteRowat(moduleId) {
    $.ajax({
        url: `/api/taattainment/${moduleId}`, // Change this URL to match your Express route
        type: 'DELETE',
        success: function() {
...
function fetchT1CO2(){
    ...
    $.ajax({
        url: '/api/tamarks', // Update the URL to match your Express route for T1attainment data
        type: 'GET',
        dataType: 'json',
...
function fetchT1CO(){
    return new Promise((resolve, reject) => {
    $.ajax({
        url: '/api/taco', // Update the URL to match your Express route for T1attainment data
        type: 'GET',
        dataType: 'json',
...
function fetchT1attainmentData2(){
    return new Promise((resolve, reject) => {
    $.ajax({
        url: '/api/taattainment', // Update the URL to match your Express route for T1attainment data
        type: 'GET',
        dataType: 'json',
...
function updatenewco(columnName,co){
    $.ajax({
        url: '/api/updatedbcota', // Update the URL to match your Express route for T1attainment data
        type: 'POST',
        dataType: 'json',
        contentType: 'application/json',
...
function updatenewmarks(columnName,marks){
    ...
    $.ajax({
        url: '/api/updatedbmarksta', // Update the URL to match your Express route for T1attainment data
        type: 'POST',
        dataType: 'json',
        contentType: 'application/json',
